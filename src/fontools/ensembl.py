...
def chrom_ensembl2ucsc(ensembl_chrom, name_mapping=None):
    if name_mapping is not None:
        ...
        ensembl_chrom == "MT"
        or ensembl_chrom == "Mito"
        or ensembl_chrom == "MtDNA"
        or ensembl_chrom == "mitochondrion_genome"
    ):
        return "chrM"
    elif ensembl_chrom.isdigit() or all([line in ["I", "V", "X", "Y"] for line in ensembl_chrom]):
