...
def get_transcripts_gff3(path_annot, convert_ucsc=False, path_mapping=None, data_source=None, filter_source=None):
    ...
    for f in fgff:
        for line in f.readlines():
            ...
            if len(line.strip()) == 0:
                continue
            seqname, source, feature, start, end, score, strand, phase, attributes_raw = line.strip().split("\t")
